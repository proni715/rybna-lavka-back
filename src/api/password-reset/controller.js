...
export const create = ({ bodymen: { body: { email, link } } }, res, next) =>
  User.findOne({ email })
    ...
    .then((reset) => {
      ...
      const content = `
        Hey, ${user.name}.<br><br>
        You requested a new password for your Rybna Lavka Back account.<br>
        ...
        &mdash; Rybna Lavka Back Team
      `
      return sendMail({ toEmail: email, subject: 'Rybna Lavka Back - Password Reset', content })
    })
